        ...
        this.router
            .navigate(
                [],
                {
                    ...
                    queryParams: { _page: params._page == 1 ? undefined : params._page, _limit: params._limit == this.restService.defaultLimit ? undefined : params._limit, q },
                }).then(() => this.restService.getActualMessages());
    }
